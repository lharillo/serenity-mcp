...
### Added
- **Dataset Source ID Handling** - All agent update methods (Activity, Copilot, Chat) now support linking dataset sources via datasetSourceIds parameter
- **ParseStringList Utility** - Flexible input parsing supporting both comma-separated values and JSON arrays
- Applied to UpdateAgent, UpdateAgentWithVersion, and all multi-agent type variants (PR #3 by Julia)
