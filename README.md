...
[![Version](https://img.shields.io/badge/version-1.4.0-blue)](https://github.com/lharillo/serenity-mcp/releases)
...
```bash
# Build image
docker build -t serenity-mcp:1.4.0 .

# Run container
docker run -p 8080:8080 serenity-mcp:1.4.0
```

**Docker Hub:** `lharillo/serenity-mcp:1.4.0`
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: serenity-mcp
        image: lharillo/serenity-mcp:1.4.0
        ports:
        - containerPort: 8080
          name: http
        env:
...
**Version:** 1.4.0 | **Status:** Production Ready ✅ | **Coverage:** 100% (75/75 tools)
